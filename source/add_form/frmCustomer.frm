...
Dim OKClick As Boolean
   ...
   frmAddEditCustomer.HeaderText = MapText("เพิ่มข้อมูลกลุ่มลูกหนี้")
...
Dim OKClick As Boolean
   ...
   frmAddEditCustomer.HeaderText = MapText("แก้ไข้อมูลกลุ่มลูกหนี้")
...
Private Sub Form_Activate()
   If Not m_HasActivate Then
      ...
      Call LoadCustomerType2(cboCustomerType)
...
Dim Temp As Long
   ...
   If Flag Then
      ...
      m_Customer.CUSTOMER_TYPE_ID = cboCustomerType.ItemData(Minus2Zero(cboCustomerType.ListIndex))
...
Dim fmsTemp As JSFormatStyle
  ...
  Col.Caption = MapText("ID")
   ...
   Col.Caption = MapText("ประเภทกลุ่มลูกหนี้")
...
Private Sub InitFormLayout()
   ...
   Call InitNormalLabel(lblCustomerType, MapText("กลุ่มลูกหนี้"))
...
Dim RealIndex As Long
   ...
   Values(4) = m_TempCustomer.CUSTOMER_TYPE_NAME
   Exit Sub
