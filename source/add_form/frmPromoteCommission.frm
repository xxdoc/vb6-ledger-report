...
Dim OKClick As Boolean
 ...
 '  If DocumentType = COMMISSION_CHART Then
    '  frmAddEditPromoteSubCommiss.DocumentType = DocumentType
      frmAddEditPromoteSubCommiss.HeaderText = MapText("เพิ่มข้อมูล Commission(พิเศษ)")
...
Dim OKClick As Boolean
 ...
 '     frmAddEditPromoteSubCommiss.DocumentType = DocumentType
      frmAddEditPromoteSubCommiss.HeaderText = MapText("แก้ไขข้อมูล Commission(พิเศษ)")        '& Comissiontype2Text(DocumentType)
