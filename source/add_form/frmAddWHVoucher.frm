...
Begin VB.Form frmAddWHVoucher 
   ClientHeight    =   8490
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   11880
   Icon            =   "frmAddWHVoucher.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin prjLedgerReport.uctlDate uctlDocumentDate 
         Height          =   405
         Left            =   1860
         TabIndex        =   1
         Top             =   1290
      ...
      Begin GridEX20.GridEX GridEX1 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "frmAddWHVoucher.frx":27A2
         Column(2)       =   "frmAddWHVoucher.frx":286A
         FormatStylesCount=   5
         FormatStyle(1)  =   "frmAddWHVoucher.frx":290E
         FormatStyle(2)  =   "frmAddWHVoucher.frx":2A6A
         FormatStyle(3)  =   "frmAddWHVoucher.frx":2B1A
         FormatStyle(4)  =   "frmAddWHVoucher.frx":2BCE
         FormatStyle(5)  =   "frmAddWHVoucher.frx":2CA6
         ImageCount      =   0
         PrinterProperties=   "frmAddWHVoucher.frx":2D5E
      End
      ...
      Begin GridEX20.GridEX GridEX2 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "frmAddWHVoucher.frx":2F36
         Column(2)       =   "frmAddWHVoucher.frx":2FFE
         FormatStylesCount=   5
         FormatStyle(1)  =   "frmAddWHVoucher.frx":30A2
         FormatStyle(2)  =   "frmAddWHVoucher.frx":31FE
         FormatStyle(3)  =   "frmAddWHVoucher.frx":32AE
         FormatStyle(4)  =   "frmAddWHVoucher.frx":3362
         FormatStyle(5)  =   "frmAddWHVoucher.frx":343A
         ImageCount      =   0
         PrinterProperties=   "frmAddWHVoucher.frx":34F2
      End
      Begin Threed.SSCommand cmdSelectAll 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddWHVoucher.frx":36CA
         ButtonStyle     =   3
      End
      Begin Threed.SSCommand cmdSelect 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddWHVoucher.frx":39E4
         ButtonStyle     =   3
      End
      Begin Threed.SSCommand cmdSearch 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddWHVoucher.frx":3CFE
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdOK 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddWHVoucher.frx":4018
         ButtonStyle     =   3
      End
   ...
   End
End
Attribute VB_Name = "frmAddWHVoucher"
...
'
'      If (BD.DO_TOTAL_PRICE + BD.REVENUE_TOTAL_PRICE + (BD.DEBIT_AMOUNT - BD.CREDIT_AMOUNT) - BD.PAID_AMOUNT) > 0 Then    'ติดค้างมากกว่ายอดหนี้
...
'         Ri.STATUS_ID = D.STATUS_ID
'         Ri.REASON_ID = D.REASON_ID
'         Ri.REASON_NAME = D.REASON_NAME
'         Ri.PRODUCT_STATUS_NAME = D.PRODUCT_STATUS_NAME
'
