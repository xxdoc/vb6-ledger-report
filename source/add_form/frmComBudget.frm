...
Dim OKClick As Boolean
   ...
   frmAddEditComBudget.HeaderText = MapText("เพิ่มข้อมูลวงเงินธนาคาร")
...
Dim OKClick As Boolean
   ...
   frmAddEditComBudget.HeaderText = MapText("แก้ไข้อมูลวงเงินธนาคาร")
...
Dim fmsTemp As JSFormatStyle
  ...
  Col.Caption = MapText("ID")
   ...
   Col.Width = 2000
   Col.Caption = MapText("เงื่อนไขวันที่")
   ...
   Col.Width = 3200
   Col.Caption = MapText("ชื่อ Manager")
   Col.TextAlignment = jgexAlignRight
...
Private Sub InitFormLayout()
   ...
   Me.Caption = MapText("ข้อมูล งบประมาณ Commercial1")
   pnlHeader.Caption = Me.Caption
   
   Call InitGrid
   
   Call InitNormalLabel(lblBankName, MapText("ชื่อ Manager"))
