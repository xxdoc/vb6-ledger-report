...
Dim oMenu As cPopupMenu
   ...
   OKClick = False
   frmExportChartAccountEx.HeaderText = "เพิ่มรายการรหัส"
...
Dim OKClick As Boolean
   ...
   frmExportChartAccountEx.HeaderText = "แก้ไขรายการรหัส"
...
Dim m_Rs As ADODB.Recordset
   ...
   lMenuChosen = oMenu.Popup("คัดลอกข้อมูล ข้ามบริษัท (ให้เข้าห้องใหม่ แล้ว ใส่ชื่อห้องเก่าที่ช่องรายการ)")
   ...
   If lMenuChosen = 1 Then
      ...
      If ItemCount > 0 Then
         While Not m_Rs.EOF
            ...
            m_Rs.MoveNext
         Wend
         glbErrorLog.LocalErrorMsg = MapText("COPY SUCCESS กรุณา REBOOT ระบบใหม่")
         glbErrorLog.ShowUserError
      Else
         glbErrorLog.LocalErrorMsg = MapText("ไม่พบข้อมูลของบริษัท") & " " & txtTemptxt.Text & " " & MapText("ในระบบแล้ว")
         glbErrorLog.ShowUserError
      End If
      Set Ac = Nothing
   End If
...
Dim Deposit As Double
   ...
   While (j < iCount)
      ...
      TempNo = m_ExcelSheet.Cells(Val(txtRow.Text) + j - 1, Val(txtCollumn.Text)).Value   ' ดึงเซลล์จาก excell
      If TempNo <> "" Then
...
Private Sub InitFormLayout()
   ...
   pnlHeader.Caption = "Export ข้อมูลผังบัญชี"
