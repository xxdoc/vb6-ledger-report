...
Dim OKClick As Boolean
   ...
   frmAddEditCostProducts.HeaderText = MapText("เพิ่มข้อมูล สินค้าต้นทุน")
...
Dim ID As Long
   ...
   If Not ConfirmDelete("สินค้า " & GridEX1.Value(3) & " ของรหัสสินค้า " & GridEX1.Value(2)) Then
      Exit Sub
   End If
...
Dim OKClick As Boolean
   ...
   frmAddEditCostProducts.HeaderText = MapText("แก้ไข้อมูล สินค้าต้นทุน")
