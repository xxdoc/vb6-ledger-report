...
Dim m_Lookup As CCommissionCustomerArea
  Set m_Lookup = New CCommissionCustomerArea
   ...
   If Not (itemCusInYear Is Nothing) Then
      glbErrorLog.LocalErrorMsg = MapText("มีลูกค้า : " & itemCusInYear.COMMISSION_CUS_ID & " " & itemCusInYear.COMMISSION_CUS_NAME & "   อยู่แล้วใน เขต : " & itemCusInYear.MASTER_AREA_NAME)
      glbErrorLog.ShowUserError
      Exit Function
   End If
