...
Begin VB.Form frmAreaShowCom 
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin GridEX20.GridEX GridEX1 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "frmAreaShowComä.frx":0000
         Column(2)       =   "frmAreaShowComä.frx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "frmAreaShowComä.frx":016C
         FormatStyle(2)  =   "frmAreaShowComä.frx":02C8
         FormatStyle(3)  =   "frmAreaShowComä.frx":0378
         FormatStyle(4)  =   "frmAreaShowComä.frx":042C
         FormatStyle(5)  =   "frmAreaShowComä.frx":0504
         ImageCount      =   0
         PrinterProperties=   "frmAreaShowComä.frx":05BC
      End
   ...
   End
End
Attribute VB_Name = "frmAreaShowCom"
...
Dim OKClick As Boolean
 ...
 ' Call glbDatabaseMngr.LockTable(m_TableName, MASTER_AREA_ID, IsCanLock, glbErrorLog)
   ...
   frmAddEditMasterArea.MASTER_AREA_ID = MASTER_AREA_ID
  frmAddEditMasterArea.HeaderText = MapText("·°È‰¢‡¢µ°“√¢“¬")
  frmAddEditMasterArea.ShowMode = SHOW_EDIT
  Load frmAddEditMasterArea
  frmAddEditMasterArea.Show 1
