...
Begin VB.Form frmAreaMasterCom 
   BackColor       =   &H80000000&
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin GridEX20.GridEX GridEX1 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "frmAreaMasterComä.frx":0000
         Column(2)       =   "frmAreaMasterComä.frx":00C8
         FormatStylesCount=   5
         FormatStyle(1)  =   "frmAreaMasterComä.frx":016C
         FormatStyle(2)  =   "frmAreaMasterComä.frx":02C8
         FormatStyle(3)  =   "frmAreaMasterComä.frx":0378
         FormatStyle(4)  =   "frmAreaMasterComä.frx":042C
         FormatStyle(5)  =   "frmAreaMasterComä.frx":0504
         ImageCount      =   0
         PrinterProperties=   "frmAreaMasterComä.frx":05BC
      End
   ...
   End
End
Attribute VB_Name = "frmAreaMasterCom"
...
Private m_YearSeq As CAreaYear
Private m_TempYearSeq As CAreaYear
...
Dim OKClick As Boolean
   ...
   frmAreaCommission.HeaderText = MapText("‡æ‘Ë¡‡¢µ°“√¢“¬·µË≈–ª’")
   frmAreaCommission.ShowMode = SHOW_ADD
   Load frmAreaCommission
  frmAreaCommission.Show 1
   
   OKClick = frmAreaCommission.OKClick
   
   Unload frmAreaCommission
   Set frmAreaCommission = Nothing
...
Private Sub cmdAddMasArea_Click()
      Load frmAreaShowCom
      frmAreaShowCom.Show 1

      Unload frmAreaShowCom
      Set frmAreaShowCom = Nothing
End Sub
...
Dim YEAR_ID As Long
  ...
  YEAR_ID = GridEX1.Value(1)
   ...
   If Not glbDaily.DeleteAreaYear(YEAR_ID, IsOK, True, glbErrorLog) Then
       m_YearSeq.YEAR_ID = -1
...
Dim OKClick As Boolean
 ...
 '  Call glbDatabaseMngr.LockTable(m_TableName, YEAR_ID, IsCanLock, glbErrorLog)
   ...
   frmAreaCommission.YEAR_ID = YEAR_ID
   frmAreaCommission.HeaderText = MapText("·°È‰¢‡¢µ°“√¢“¬√“¬ª’")
   frmAreaCommission.ShowMode = SHOW_EDIT
   Load frmAreaCommission
   frmAreaCommission.Show 1
...
'      End If
       ...
       If Not glbDaily.QueryAreaYear(m_YearSeq, m_Rs, ItemCount, IsOK, glbErrorLog) Then
         glbErrorLog.ShowErrorLog (LOG_FILE_MSGBOX)
         Call EnableForm(Me, True)
         Exit Sub
       End If
...
Private Sub InitFormLayout()
   ...
   cmdAddMasArea.Picture = LoadPicture(glbParameterObj.NormalButton1)
   ...
   Call InitMainButton(cmdAddMasArea, MapText("‡¢µ°“√¢“¬"))
End Sub
...
Private Sub Form_Load()
   m_TableName = "AREA_YEAR"
   m_HasActivate = False
   Set m_YearSeq = New CAreaYear
   Set m_TempYearSeq = New CAreaYear
...
On Error Resume Next
   ...
   cmdAddMasArea.Top = ScaleHeight - 580
   cmdAddMasArea.Left = cmdExit.Left - cmdOK.Width - 50 - cmdAddMasArea.Width - 50
End Sub
