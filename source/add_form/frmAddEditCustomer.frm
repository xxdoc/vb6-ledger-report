...
Begin VB.Form frmAddEditCustomer 
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin VB.ComboBox cboCustomerTypeID 
         Height          =   315
         Left            =   2340
      ...
      Begin Threed.SSCommand cmdOK 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditCustomer.frx":27A2
         ButtonStyle     =   3
      End
   End
End
...
Dim ItemCount As Long
   ...
   If Flag Then
      ...
      If Not glbDaily.QueryCustomer2(m_Customer, m_Rs, ItemCount, IsOK, glbErrorLog) Then
   ...
   If ItemCount > 0 Then
      ...
      txtCustomerCode.Text = m_Customer.CUSTOMER_CODE
      txtCustomerName.Text = m_Customer.CUSTOMER_NAME
      cboCustomerTypeID.ListIndex = IDToListIndex(cboCustomerTypeID, m_Customer.CUSTOMER_TYPE_ID)
   End If
...
Dim IsOK As Boolean
   ...
   If Not VerifyTextControl(lblCustomerCode, txtCustomerCode, False) Then
      Exit Function
   End If
   If Not VerifyCombo(lblCustomerTypeID, cboCustomerTypeID, False) Then
      Exit Function
   End If
...
'   End If
   ...
   m_Customer.CUSTOMER_ID = ID
   m_Customer.CUSTOMER_CODE = txtCustomerCode.Text
   m_Customer.CUSTOMER_NAME = txtCustomerName.Text
   m_Customer.CUSTOMER_TYPE_ID = cboCustomerTypeID.ItemData(Minus2Zero(cboCustomerTypeID.ListIndex))
...
Private Sub Form_Activate()
   If Not m_HasActivate Then
      ...
      Call LoadCustomerType2(cboCustomerTypeID)
...
Private Sub InitFormLayout()
   ...
   Call InitNormalLabel(lblCustomerTypeID, MapText("ประเภทกลุ่ม"))
   ...
   Call InitCombo(cboCustomerTypeID)
