...
Dim OKClick As Boolean
   ...
   frmAddEditXlsSetFarm.HeaderText = MapText("เพิ่มข้อมุลการขนส่ง")
...
Dim OKClick As Boolean
   ...
   frmAddEditXlsSetFarm.HeaderText = MapText("แก้ไข้อมูลค่าขนส่ง")
...
Private Sub InitFormLayout()
   ...
   SSFrame1.PictureBackground = LoadPicture(glbParameterObj.NormalForm1)
    Me.Caption = MapText("ตั้งค่าค่าขนส่ง")
