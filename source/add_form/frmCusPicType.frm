...
Dim OKClick As Boolean
   ...
   frmAddEditCusPigType.HeaderText = MapText("เพิ่มข้อมูลกลุ่มลูกหนี้")
...
Dim OKClick As Boolean
   ...
   frmAddEditCusPigType.HeaderText = MapText("แก้ไขข้อมูลประเภทหมู")
...
Dim fmsTemp As JSFormatStyle
  ...
  Col.Caption = MapText("ID")
   ...
   Col.Width = 8000
    ...
    Col.Width = 2000
    Col.Caption = MapText("จำนวนหมูพันธุ์")
    
    Set Col = GridEX1.Columns.Add '5
    Col.Width = 2000
    Col.Caption = MapText("จำนวนหมูขุน")
   
    Set Col = GridEX1.Columns.Add '6
    Col.Width = 2000
    Col.Caption = MapText("จำนวนลูกหมู")
   GridEX1.ItemCount = 0
End Sub
Private Sub InitFormLayout()
   ...
   Me.Caption = MapText("ข้อมูลจำนวนหมูแต่ละประเภท")
