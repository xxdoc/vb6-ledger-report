...
Dim OKClick As Boolean
   ...
   frmAddEditProvinceMap.HeaderText = MapText("เพิ่มข้อมูล MAP จังหวัด")
...
Dim OKClick As Boolean
   ...
   frmAddEditProvinceMap.HeaderText = MapText("แก้ไข้อมูลกลุ่มเจ้าหนี้")
...
Dim fmsTemp As JSFormatStyle
   ...
   Col.Width = 3000
   Col.Caption = MapText("คำค้นหาจังหวัด")
   
   Set Col = GridEX1.Columns.Add '3
   Col.Width = 2000
   Col.Caption = MapText("คำแทนจังหวัด")
...
Private Sub InitFormLayout()
   ...
   Me.Caption = MapText("ข้อมูล MAP จังหวัด")
   pnlHeader.Caption = Me.Caption
   
   Call InitGrid
   
   Call InitNormalLabel(lblKeySearch, MapText("คำค้นหาจังหวัด"))
