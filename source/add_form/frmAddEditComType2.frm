...
Begin VB.Form frmAddEditComType2 
   BackColor       =   &H80000000&
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin Threed.SSPanel ppnlHeader 
         ...
         PictureBackgroundStyle=   2
      End
      Begin Threed.SSCheck chkSelectFlag 
         Height          =   375
         Left            =   2760
         TabIndex        =   9
         Top             =   2040
   ...
   End
End
Attribute VB_Name = "frmAddEditComType2"
                ...
                m_CConditionCommission.QueryFlag = 1
                  ...
                  End If
                     ...
                     If ItemCount > 0 Then
                        ...
                        chkSelectFlag.Value = FlagToCheck(m_CConditionCommission.Flag)
...
If DB_TYP = 1 Then       ' เลือกตารางโปรโมต
   ...
   m_CPromoteCommission.Commiss_TYP = "01"
   m_CPromoteCommission.MASTER_COMMISS_SUB_PROMOTE_ID = MASTER_COMMISS_SUB_PROMOTE_ID
   m_CPromoteCommission.MASTER_Commiss_ID = MASTER_Commiss_ID
...
Else
   ...
   m_CConditionCommission.COMTYP = "01"
   m_CConditionCommission.YEAR_ID = YEAR_ID
   ...
   m_CConditionCommission.Flag = Check2Flag(chkSelectFlag.Value)
...
Private Sub InitFormLayout()
   ...
   Call InitNormalLabel(lblNumOne, MapText("ยอดขาย(%)"))
   Call uctlNumOne.SetTextLenType(TEXT_FLOAT, glbSetting.DOUBLE_TYPE)
   Call InitCheckBox(chkSelectFlag, "กรณี100%")
   
 Call InitNormalLabel(lblSlmPercent, MapText("ค่าคอมมิชชั่นขาย(%)"))
...
Private Sub chkSelectFlag_Click(Value As Integer)
      m_HasModify = True
End Sub
