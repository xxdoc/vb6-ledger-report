   ...
   Else
      If txtYear.Enabled Then
         If m_SetTimeFlag Then
            InternalDate = Format(Val(txtYear) - 543, "0000") & Format(cboMonth.ListIndex, "00") & Format(txtDay, "00")
         Else
            InternalDate = Format(Val(txtYear) - 543, "0000") & Format(cboMonth.ListIndex, "00") & Format(txtDay, "00")
         End If
      Else
         If m_SetTimeFlag Then
            InternalDate = Format(Year(Now), "0000") & Format(cboMonth.ListIndex, "00") & Format(txtDay, "00")
         Else
            InternalDate = Format(Year(Now), "0000") & Format(cboMonth.ListIndex, "00") & Format(txtDay, "00")
         End If
      End If
