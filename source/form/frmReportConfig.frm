...
Begin VB.Form frmReportConfig 
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin VB.ComboBox cboFontName 
         ...
         Width           =   3525
      End
      Begin prjLedgerReport.uctlTextBox txtPaperWidth 
         Height          =   435
         Left            =   1860
         TabIndex        =   2
         Top             =   1530
      ...
      Begin prjLedgerReport.uctlTextBox uctlTextBox1 
         ...
         _extenty        =   767
      End
      Begin prjLedgerReport.uctlTextBox txtPaperHeight 
         Height          =   435
         Left            =   6000
         TabIndex        =   3
         Top             =   1530
         ...
         _extenty        =   767
      End
      Begin prjLedgerReport.uctlTextBox txtMarginBottom 
         Height          =   435
         Left            =   6000
         TabIndex        =   5
         Top             =   1980
         ...
         _extenty        =   767
      End
      Begin prjLedgerReport.uctlTextBox txtMarginHeader 
         Height          =   435
         Left            =   1860
         TabIndex        =   8
         Top             =   2880
         ...
         _extenty        =   767
      End
      Begin prjLedgerReport.uctlTextBox txtMarginFooter 
         Height          =   435
         Left            =   6000
         TabIndex        =   9
         Top             =   2880
         ...
         _extenty        =   767
      End
      Begin prjLedgerReport.uctlTextBox txtMarginTop 
         Height          =   435
         Left            =   1860
         TabIndex        =   4
         Top             =   1980
         ...
         _extenty        =   767
      End
      Begin prjLedgerReport.uctlTextBox txtMarginLeft 
         Height          =   435
         Left            =   1860
         TabIndex        =   6
         Top             =   2430
         ...
         _extenty        =   767
      End
      Begin prjLedgerReport.uctlTextBox uctlTextBox8 
         Height          =   435
         Left            =   1860
         TabIndex        =   10
         Top             =   3330
         ...
         _extenty        =   767
      End
      Begin prjLedgerReport.uctlTextBox txtMarginRight 
         Height          =   435
         Left            =   6000
         TabIndex        =   7
         Top             =   2430
         ...
         _extenty        =   767
      End
      Begin prjLedgerReport.uctlTextBox uctlTextBox10 
         Height          =   435
         Left            =   6000
         TabIndex        =   11
         Top             =   3330
...
'      End If
   ...
   If Not VerifyCombo(lblPaperSize, cboPaperSize, False) Then
      Exit Function
   End If
   ...
   If Not VerifyTextControl(lblPaperHeight, txtPaperHeight, True) Then
      Exit Function
   End If
   If Not VerifyTextControl(lblMarginTop, txtMarginTop, False) Then
      Exit Function
   End If
   If Not VerifyTextControl(lblMarginBottom, txtMarginBottom, False) Then
      Exit Function
   End If
   If Not VerifyTextControl(lblMarginLeft, txtMarginLeft, False) Then
      Exit Function
   End If
   If Not VerifyTextControl(lblMarginRight, txtMarginRight, False) Then
      Exit Function
   End If
   ...
   m_ReportConfig.COMPUTER_NAME = glbParameterObj.ComputerName
